#!/usr/bin/env python3
"""
Генератор списка бесплатных прокси для GreenSpark парсера
Источники: sslproxies.org, free-proxy-list.net, GitHub массовые списки
"""
...
GITHUB_PROXY_SOURCES = [
    # TheSpeedX/PROXY-List (~44,000 proxies)
...
def test_proxy(proxy, timeout=5, test_url="https://green-spark.ru/"):
    """Test if proxy works with GreenSpark"""
    try:
...
if __name__ == "__main__":
    ...
    print(f"  python parser.py --proxy-file proxies.txt --all-cities")
